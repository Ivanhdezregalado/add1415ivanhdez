...
BEGIN{
	...
	dominio="OU=Formacion Profesional,DC=IHERREG,DC=ADD";
...
}
{
	...
	print "dsadd user ­upn "usuario"@IHERREG.ADD \"CN="nombreordenado","unidad"\" ­samid "usuario" ­disabled no ­pwd $M"clave"a# ­mustchpwd yes ­memberof \""grupo"\" ­fn \""nombre"\" ­ln \""apellido1" "apellido2"\" ­display \""nombrecompleto"\" -q" > fichero
